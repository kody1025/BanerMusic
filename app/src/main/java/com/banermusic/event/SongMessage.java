...
public class SongMessage {
     ...
     * 缓存更新
     */
    public static final int BUFFER_UPDATE = 30;

    /**
     * 播放界面初始化
     */
    public static final int PLAY_UI_INIT = 31;

    /**
     * 播放标识，相关UI更新
     */
    public static final int PLAY_UI = 32;

    /**
     * 暂停标识，相关UI更新
     */
    public static final int PAUSE_UI = 33;
